...
class MPU9250:
    ...
    def searchDevice(self):
        ...
        #if(who_am_i == DEVICE_ID): return True
        #else: return False
        return who_am_i
    ## Configure MPU-9250
    #  @param [in] self The object pointer.
    ...
    def configMPU9250(self, gfs, afs):
        if gfs == GFS_250: self.gres = 250.0/32768.0
        elif gfs == GFS_500: self.gres = 500.0/32768.0
        elif gfs == GFS_1000: self.gres = 1000.0/32768.0
        else: self.gres = 2000.0/32768.0 # gfs == GFS_2000
    ...
    def readTemperature(self):
        ...
        return temp
    def readRow(self):
        return bus.read_i2c_block_data(self.address, ACCEL_OUT, 14)
#        data.append(bus.read_i2c_block_data(self.address, ACCEL_OUT, 6))# acceleometr
#        data.append(bus.read_i2c_block_data(self.address, GYRO_OUT, 6))# gyroscope
#        data.append(bus.read_i2c_block_data(self.address, TEMP_OUT, 2))# temp
#        data.append(bus.read_i2c_block_data(AK8963_SLAVE_ADDRESS, AK8963_MAGNET_OUT, 7)) # magneto
        #return data
    ## Data Convert
    # @param [in] self The object pointer.
    # @param [in] data1 LSB
